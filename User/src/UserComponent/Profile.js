            ...
            <div className="second__div">
                 <div className="upper__slick">
                   ...
                   <div className="upper__div2">
                        <h5 className="hello__tag">Hello, {localStorage.getItem("UserName")}</h5>
                    <h5 className="hello__tag">{localStorage.getItem("loggedUser")}</h5>
                   </div>
            </div>
                <div className="detail__div">
                    <table>
                        <tr><td>   <h4>User Name</h4></td><td> <input type="text" value={localStorage.getItem("UserName")} ></input></td></tr>
                        <tr><td>   <h4>First Name</h4></td><td>    <input type="text" value={localStorage.getItem("fname")} ></input></td></tr>
                        <tr><td> <h4>Last Name</h4></td><td>  <input type="text" value={localStorage.getItem("lname")} ></input></td></tr>
                        <tr><td>  <h4>Email ID </h4></td><td>  <input type="text" value={localStorage.getItem("loggedUser")}></input></td></tr>
                        <tr><td>  <h4>Gender</h4></td><td> <input type="text" value={localStorage.getItem("gender")}></input></td></tr>
                        <tr><td>  <h4>Address</h4></td><td><textarea rows="5" cols="25" value={localStorage.getItem("address")}></textarea></td></tr>
                        <tr><td> <h4>Wallet Amount </h4></td><td><input type="text" value={"₹ "+ localStorage.getItem("wallet")}></input></td></tr>
                    </table>
                </div>
            </div>
